...
const home_controller_1 = require("../../controller/user/home.controller");
exports.userRouterGroup = express_1.default.Router();
exports.userRouterGroup.use(auth_1.verifyApiToken);
...
exports.userRouterGroup.get("/home", home_controller_1.index);
