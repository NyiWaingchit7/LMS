...
const app_route_1 = require("@/routes/app.route");
...
const lecture_route_1 = require("@/routes/lecture.route");
const lesson_route_1 = require("@/routes/lesson.route");
const page_route_1 = require("@/routes/page.route");
const payment_account_route_1 = require("@/routes/payment_account.route");
const payment_bank_route_1 = require("@/routes/payment_bank.route");
...
const tagline_route_1 = require("@/routes/tagline.route");
const user_route_1 = require("@/routes/user.route");
const auth_route_1 = require("@/routes/user/auth.route");
const category_route_2 = require("@/routes/user/category.route");
const lecture_route_2 = require("@/routes/user/lecture.route");
const lesson_route_2 = require("@/routes/user/lesson.route");
const payment_route_1 = require("@/routes/user/payment.route");
const setting_route_2 = require("@/routes/user/setting.route");
const tagLine_route_1 = require("@/routes/user/tagLine.route");
const auth_1 = require("@/utils/auth");
const fileUpload_1 = require("@/utils/fileUpload");
const popular_lecture_route_1 = require("@/routes/popular_lecture.route");
...
app.use("/api/v1/admin/settings", setting_route_1.settingRouter);
app.use("/api/v1/admin/tag-lines", tagline_route_1.tagLineRouter);
app.use("/api/v1/admin/popular-lectures", popular_lecture_route_1.popularLectureRouter);
// user
...
app.use("/api/v1/tag-lines", tagLine_route_1.userTagLineRouter);
app.use("/api/v1/settings", setting_route_2.userSettingRouter);
app.use("/api/v1/popular-lectures", popular_lecture_route_1.popularLectureRouter);
